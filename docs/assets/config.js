window.SITE_CONFIG = {
  siteTitle: 'UMA - Deep Learning and Its Applications',
  courseCode: 'CO3133',
  courseTitle: 'Deep Learning and Its Applications',
  ...
  assignments: [
    {
      ...
      trackLinks: {
        text: {
          demoVideo: '',
          presentationVideo: 'https://youtu.be/jVdCQGbwC3U',
          code: 'https://colab.research.google.com/drive/1lR2g-ZhHXLKyL06A9EPAhEdA8MbkZIDo?usp=sharing',
          presentationContent: 'https://docs.google.com/presentation/d/15oflcLnoYwTbu06x41ShLeXOURpBEKKbYQkUBg9S1es/edit?slide=id.g3d3a0908436_1_0#slide=id.g3d3a0908436_1_0'
        },
        image: {
          demoVideo: '',
      ...
      deliverables: [
        ...
        'Model building, training, evaluation, and comparison',
        'Experimental results with tables, figures, and discussion',
        'Extensions such as interpretability, robustness, or efficiency analysis'
      ]
    },
    {
      id: 'assignment-2',
